...
function ComputeAugL(necon,IdUpp,epsilon,eta,c_k,mulam,a_nux,q_nuxlam,diagg2lam,G_k,bnab_xL_k,Q_1,J_1,Q_2,G_ktl,M_k)
    # inequality constraints
    cc_k = c_k[IdUpp:end]
    lam_k = mulam[IdUpp:end]
    ...
    J_2c = G_k[IdUpp:end,:]*bnab_xL_k + Pcdiagg2lam
    # Compute augmented Lagrangian gradient
    bnab_xaugL_k1 = bnab_xL_k+eta*Q_1*J_1+eta*Q_2*J_2c+1/epsilon*G_k'[:,1:necon]*c_k[1:necon]+1/(epsilon*q_nuxlam)*G_k'[:,IdUpp:end]*omega_epsnu_xlam
