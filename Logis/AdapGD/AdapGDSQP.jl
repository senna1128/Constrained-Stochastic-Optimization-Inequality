...
function AdapGDSQP(Id_Design,Id_Sig,Gau_Sigma,Exp_Sigma,C_matrix,q_vector,kap,cerr,cgrad,Max_Iter,EPS_Step,EPS_Res,epsilon,delta,eta,beta,alpha_max,rho,kap_grad,kap_f,chi_grad,chi_f,p_grad,p_f)
